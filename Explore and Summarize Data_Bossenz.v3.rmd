...
In order to answer this quastion I am going to build the scatterplot matrics, which give me a possability to compare all properties in one step.
...
I tried to explore unusual distributions with scatterplot matrics. Unfortenately I cannot recognise anything. Thus I will try to analyse every element separatly. By this analysis I will also look at the person correlation. I am interested in the elements which have a high correlation with the quality.
...
```{r echo=FALSE}
qplot(x=pf$residual.sugar, xlab="residual.sugar", binwidth = 0.5)+
...
```{r echo=FALSE}
qplot(x=pf$total.sulfur.dioxide, xlab="total.sulfur.dioxide", binwidth = 1)+
...
```{r echo=FALSE}
qplot(x=pf$free.sulfur.dioxide, xlab="free.sulfur.dioxide", binwidth = 1)+
